...
#ifndef itkCurvilinearArraySpecialCoordinatesFFTImageFilterFactory_h
#define itkCurvilinearArraySpecialCoordinatesFFTImageFilterFactory_h
...
class CurvilinearArraySpecialCoordinatesFFTImageFilterFactory : public itk::ObjectFactoryBase
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(CurvilinearArraySpecialCoordinatesFFTImageFilterFactory);

  using Self = CurvilinearArraySpecialCoordinatesFFTImageFilterFactory;
  ...
  itkTypeMacro(CurvilinearArraySpecialCoordinatesFFTImageFilterFactory, itk::ObjectFactoryBase);

  /** Register one factory of this type  */
  static void
  RegisterOneFactory()
  {
    CurvilinearArraySpecialCoordinatesFFTImageFilterFactory::Pointer factory =
      CurvilinearArraySpecialCoordinatesFFTImageFilterFactory::New();
...
protected:
  ...
  {
    using InputImageType = CurvilinearArraySpecialCoordinatesImage<InputPixelType, D>;
  ...
  CurvilinearArraySpecialCoordinatesFFTImageFilterFactory()
  {
